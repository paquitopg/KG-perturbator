...
class AzureLLM(BaseLLMWrapper):
    ...
    def __init__(self, model_name: Optional[str] = None, 
        ...
        Args:
            model_name (Optional[str]): The base model name. Defaults to AZURE_OPENAI_MODEL_NAME env var.
            deployment_name (Optional[str]): Azure deployment name. Defaults to AZURE_OPENAI_DEPLOYMENT_NAME env var.
        ...
        """
        _model_name = model_name or os.getenv("AZURE_OPENAI_MODEL_NAME")
        if not _model_name:
            raise ValueError("Azure model name must be provided via argument or AZURE_OPENAI_MODEL_NAME env var.")
        ...
        if not self.deployment_name:
            raise ValueError("Azure deployment name must be provided via argument or AZURE_OPENAI_DEPLOYMENT_NAME env var.")
